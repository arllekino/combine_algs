...
private:
    ...
    static std::shared_ptr<Edge> CreateEdge(const std::shared_ptr<Vertex>& start, const std::shared_ptr<Vertex>& end);
    ...
    double CrossProduct(const Position& a, const Position& b, const Position& c);
